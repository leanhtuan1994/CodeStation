...
class __Mustache_c17f4606281ffa2b858ef81552ed2345 extends Mustache_Template
{
...
';
        ...
        // 'disabled' section
        $value = $context->find('disabled');
        $buffer .= $this->section236509f90ad156c71e6ca69a90c76a23($context, $indent, $value);
    ...
    private function section236509f90ad156c71e6ca69a90c76a23(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();

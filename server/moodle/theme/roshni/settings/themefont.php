...
$customcss = 'customcss';
$customcss_for_homepage = $DB->get_record_sql('select config.value from {config_plugins} config where config.plugin="'.$pluginname.'" and config.name="'.$customcss.'"');
if(!empty($customcss_for_homepage->value)) { ?>
<style type="text/css">
<?php echo $customcss_for_homepage->value;?>
</style>
<?php }
